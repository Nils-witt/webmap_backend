...
import dev.nilswitt.webmap.base.ui.views.components.SecurityGroupEditDialog;
import dev.nilswitt.webmap.base.ui.views.filters.SecurityGroupFilter;
...
public class SecurityGroupView extends VerticalLayout {
    ...
    public SecurityGroupView(SecurityGroupRepository repository, AuthenticationContext authenticationContext, PermissionVerifier permissionVerifier) {
        ...
        this.createBtn = new Button("Create", event -> {
            ...
            if (!PermissionVerifier.hasAnyScope(user, SecurityGroup.UserRoleTypeEnum.SECURITYGROUP,
