...
- **`dev.nilswitt.webmap.base`**: Reusable components and base classes for all features
...
- **`dev.nilswitt.webmap.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `dev.nilswitt.webmap` (e.g., `dev.nilswitt.webmap.myfeature`)
